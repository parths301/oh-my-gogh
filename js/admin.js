...
(function () {
  ...
  function paymentsView() {
    ...
    return '<div><div style="background:#15315C;color:#F3EDDD;border-radius:18px;padding:22px 24px;display:flex;gap:16px;align-items:flex-start;flex-wrap:wrap">' +
      ...
      '<p style="font-size:13px;line-height:1.6;color:rgba(243,237,221,.78);margin-top:6px;max-width:62ch"><span style="font-family:\'Space Mono\',monospace;color:#E0A93A">Razorpay</span> powers live checkout. Set <span style="font-family:\'Space Mono\',monospace;color:#E0A93A">RAZORPAY_KEY_ID</span> and <span style="font-family:\'Space Mono\',monospace;color:#E0A93A">RAZORPAY_KEY_SECRET</span> in your Vercel environment variables (use test keys first). The secret key stays server-side and is never sent to the browser.</p></div></div>' +
